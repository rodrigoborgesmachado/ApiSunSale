...
{
    public class WhosthatpokemonresultRepository : RepositoryBase<Main>, IMainRepository
    {
        public WhosthatpokemonresultRepository(ApiSunSaleContext currentContext)
            : base(currentContext)
        {
        }
