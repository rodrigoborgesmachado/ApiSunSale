...
{
    public class ResultadostabuadadivertidaRepository : RepositoryBase<Main>, IMainRepository
    {
        public ResultadostabuadadivertidaRepository(ApiSunSaleContext currentContext)
            : base(currentContext)
        {
        }
