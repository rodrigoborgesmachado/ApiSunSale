...
{
    public class RecuperasenhaconcursandoRepository : RepositoryBase<Main>, IMainRepository
    {
        public RecuperasenhaconcursandoRepository(ApiSunSaleContext currentContext)
            : base(currentContext)
        {
        }
