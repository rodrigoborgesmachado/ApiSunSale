...
{
    public class CartaocreditodevtoolsRepository : RepositoryBase<Main>, IMainRepository
    {
        public CartaocreditodevtoolsRepository(ApiSunSaleContext currentContext)
            : base(currentContext)
        {
        }
