...
using ApiSunSale.Infrastructure.Data.Helpers;
...
namespace ApiSunSale.Infrastructure.Data.Repository
{
    ...
    {
        protected readonly ApiSunSaleContext _currentContext;

        public RepositoryBase(ApiSunSaleContext currentContext)
        {
