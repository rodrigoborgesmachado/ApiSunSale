...
{
    public class RecuperasenhacrudformsRepository : RepositoryBase<Main>, IMainRepository
    {
        public RecuperasenhacrudformsRepository(ApiSunSaleContext currentContext)
            : base(currentContext)
        {
        }
