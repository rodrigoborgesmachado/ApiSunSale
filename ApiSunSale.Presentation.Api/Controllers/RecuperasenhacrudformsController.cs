...
using IMainAppService = ApiSunSale.Application.Interfaces.IRecuperasenhacrudformsAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Recuperasenhacrudforms")]
    public class RecuperasenhacrudformsController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public RecuperasenhacrudformsController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
