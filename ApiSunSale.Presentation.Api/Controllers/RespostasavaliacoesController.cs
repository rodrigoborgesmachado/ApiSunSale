...
using IMainAppService = ApiSunSale.Application.Interfaces.IRespostasavaliacoesAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Respostasavaliacoes")]
    public class RespostasavaliacoesController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public RespostasavaliacoesController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
