...
using IMainAppService = ApiSunSale.Application.Interfaces.ITesteAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Teste")]
    public class TesteController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public TesteController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
