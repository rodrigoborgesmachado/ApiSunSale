...
using IMainAppService = ApiSunSale.Application.Interfaces.IProvaAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Prova")]
    public class ProvaController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ProvaController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
