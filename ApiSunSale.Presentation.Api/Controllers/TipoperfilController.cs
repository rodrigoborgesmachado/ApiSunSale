...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Tipoperfil")]
    public class TipoperfilController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public TipoperfilController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
