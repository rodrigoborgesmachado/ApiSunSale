...
using IMainAppService = ApiSunSale.Application.Interfaces.IVeiculosfordevAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Veiculosfordev")]
    public class VeiculosfordevController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public VeiculosfordevController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
