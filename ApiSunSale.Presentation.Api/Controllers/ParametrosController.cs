...
using IMainAppService = ApiSunSale.Application.Interfaces.IParametrosAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Parametros")]
    public class ParametrosController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ParametrosController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
