...
using IMainAppService = ApiSunSale.Application.Interfaces.IRespostasquestoesAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Respostasquestoes")]
    public class RespostasquestoesController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public RespostasquestoesController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
