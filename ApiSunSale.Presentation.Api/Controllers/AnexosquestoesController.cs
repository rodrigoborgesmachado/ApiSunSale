...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Anexosquestoes")]
    public class AnexosquestoesController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public AnexosquestoesController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
