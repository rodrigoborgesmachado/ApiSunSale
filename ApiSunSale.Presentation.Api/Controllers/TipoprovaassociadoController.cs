...
using IMainAppService = ApiSunSale.Application.Interfaces.ITipoprovaassociadoAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("TipoProvaAssociado")]
    public class TipoprovaassociadoController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public TipoprovaassociadoController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
