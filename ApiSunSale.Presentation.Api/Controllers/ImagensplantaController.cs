...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Imagensplanta")]
    public class ImagensplantaController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ImagensplantaController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
