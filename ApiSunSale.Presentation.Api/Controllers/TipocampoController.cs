...
using IMainAppService = ApiSunSale.Application.Interfaces.ITipocampoAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Tipocampo")]
    public class TipocampoController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public TipocampoController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
