...
using IMainAppService = ApiSunSale.Application.Interfaces.IRelacaoAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Relacao")]
    public class RelacaoController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public RelacaoController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
