...
using IMainAppService = ApiSunSale.Application.Interfaces.IEmailAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Email")]
    public class EmailController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public EmailController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
