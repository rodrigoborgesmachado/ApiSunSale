...
using IMainAppService = ApiSunSale.Application.Interfaces.IConfiguracaoemailAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Configuracaoemail")]
    public class ConfiguracaoemailController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ConfiguracaoemailController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
