...
using IMainAppService = ApiSunSale.Application.Interfaces.IUsuarioconcursandoAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Usuarioconcursando")]
    public class UsuarioconcursandoController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public UsuarioconcursandoController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
