...
using IMainAppService = ApiSunSale.Application.Interfaces.IQuestoesavaliacaoAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Questoesavaliacao")]
    public class QuestoesavaliacaoController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public QuestoesavaliacaoController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
