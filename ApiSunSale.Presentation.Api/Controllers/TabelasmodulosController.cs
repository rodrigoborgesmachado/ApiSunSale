...
using IMainAppService = ApiSunSale.Application.Interfaces.ITabelasmodulosAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Tabelasmodulos")]
    public class TabelasmodulosController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public TabelasmodulosController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
