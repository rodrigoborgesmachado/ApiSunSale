...
using IMainAppService = ApiSunSale.Application.Interfaces.IVerbosAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Verbos")]
    public class VerbosController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public VerbosController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
