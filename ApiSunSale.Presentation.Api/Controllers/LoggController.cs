...
using IMainAppService = ApiSunSale.Application.Interfaces.ILoggAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Logg")]
    public class LoggController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public LoggController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
