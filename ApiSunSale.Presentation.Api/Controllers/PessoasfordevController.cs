...
using IMainAppService = ApiSunSale.Application.Interfaces.IPessoasfordevAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Pessoasfordev")]
    public class PessoasfordevController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public PessoasfordevController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
