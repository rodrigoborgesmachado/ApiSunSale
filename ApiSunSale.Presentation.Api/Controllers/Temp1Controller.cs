...
using IMainAppService = ApiSunSale.Application.Interfaces.ITemp1AppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Temp1")]
    public class Temp1Controller : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public Temp1Controller(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
