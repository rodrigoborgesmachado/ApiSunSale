...
using IMainAppService = ApiSunSale.Application.Interfaces.IRecuperasenhaconcursandoAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Recuperasenhaconcursando")]
    public class RecuperasenhaconcursandoController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public RecuperasenhaconcursandoController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
