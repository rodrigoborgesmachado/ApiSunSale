...
using IMainAppService = ApiSunSale.Application.Interfaces.IPlantasAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Plantas")]
    public class PlantasController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public PlantasController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
