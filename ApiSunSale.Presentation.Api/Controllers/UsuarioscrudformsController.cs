...
using IMainAppService = ApiSunSale.Application.Interfaces.IUsuarioscrudformsAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Usuarioscrudforms")]
    public class UsuarioscrudformsController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public UsuarioscrudformsController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
