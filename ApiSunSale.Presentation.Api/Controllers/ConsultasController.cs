...
using IMainAppService = ApiSunSale.Application.Interfaces.IConsultasAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Consultas")]
    public class ConsultasController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ConsultasController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
