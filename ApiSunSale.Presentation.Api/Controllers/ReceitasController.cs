...
using IMainAppService = ApiSunSale.Application.Interfaces.IReceitasAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Receitas")]
    public class ReceitasController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ReceitasController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
