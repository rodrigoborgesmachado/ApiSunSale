...
using IMainAppService = ApiSunSale.Application.Interfaces.IVersaoAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Versao")]
    public class VersaoController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public VersaoController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
