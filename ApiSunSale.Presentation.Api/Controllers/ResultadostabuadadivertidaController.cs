...
using IMainAppService = ApiSunSale.Application.Interfaces.IResultadostabuadadivertidaAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Resultadostabuadadivertida")]
    public class ResultadostabuadadivertidaController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ResultadostabuadadivertidaController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
        ...
        [HttpGet("{code}")]
        public async Task<IActionResult> Get(string code, string? include = null)
        {
        ...
        /// <returns><![CDATA[Task<PaggedBaseReturn<MainViewModel>>]]></returns>
        [HttpGet("export")]
        public async Task<IActionResult> Export(DateTime? startDate, DateTime? endDate, string isActive = null, string term = null, string orderBy = null, string? include = null)
        {
            var result = await _mainAppService.GetReport(startDate, endDate, isActive, term, orderBy: orderBy, include: include);
