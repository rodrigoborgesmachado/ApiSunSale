...
using IMainAppService = ApiSunSale.Application.Interfaces.IEmailbackupAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Emailbackup")]
    public class EmailbackupController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public EmailbackupController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
