...
using IMainAppService = ApiSunSale.Application.Interfaces.IPostagemAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Postagem")]
    public class PostagemController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public PostagemController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
