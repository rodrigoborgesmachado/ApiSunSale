...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Usuarios")]
    public class UsuariosController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public UsuariosController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
