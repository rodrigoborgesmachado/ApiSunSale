...
using IMainAppService = ApiSunSale.Application.Interfaces.IVerboconjugadoAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Verboconjugado")]
    public class VerboconjugadoController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public VerboconjugadoController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
