...
using IMainAppService = ApiSunSale.Application.Interfaces.ISavedresultswppAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("SavedResultsWpp")]
    public class SavedresultswppController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public SavedresultswppController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
