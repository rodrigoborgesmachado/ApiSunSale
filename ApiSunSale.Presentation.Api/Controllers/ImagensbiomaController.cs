...
using IMainAppService = ApiSunSale.Application.Interfaces.IImagensbiomaAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Imagensbioma")]
    public class ImagensbiomaController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ImagensbiomaController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
