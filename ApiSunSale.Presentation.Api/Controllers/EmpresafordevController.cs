...
using IMainAppService = ApiSunSale.Application.Interfaces.IEmpresafordevAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Empresafordev")]
    public class EmpresafordevController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public EmpresafordevController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
