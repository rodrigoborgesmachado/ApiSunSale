...
using IMainAppService = ApiSunSale.Application.Interfaces.IClientesAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    public class ClientesController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ClientesController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
