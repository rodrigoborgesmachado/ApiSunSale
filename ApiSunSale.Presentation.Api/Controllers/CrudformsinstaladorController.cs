...
using IMainAppService = ApiSunSale.Application.Interfaces.ICrudformsinstaladorAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Crudformsinstalador")]
    public class CrudformsinstaladorController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public CrudformsinstaladorController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
