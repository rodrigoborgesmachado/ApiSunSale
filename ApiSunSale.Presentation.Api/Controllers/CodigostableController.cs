...
using IMainAppService = ApiSunSale.Application.Interfaces.ICodigostableAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("CodigosTable")]
    public class CodigostableController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public CodigostableController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
