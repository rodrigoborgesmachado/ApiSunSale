...
using IMainAppService = ApiSunSale.Application.Interfaces.IVerificacaousuarioAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("VerificacaoUsuario")]
    public class VerificacaousuarioController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public VerificacaousuarioController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
