...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("TipoProva")]
    public class TipoprovaController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public TipoprovaController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
