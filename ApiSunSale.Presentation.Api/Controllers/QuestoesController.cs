...
using IMainAppService = ApiSunSale.Application.Interfaces.IQuestoesAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Questoes")]
    public class QuestoesController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public QuestoesController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
