...
using IMainAppService = ApiSunSale.Application.Interfaces.IDespesasAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Despesas")]
    public class DespesasController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public DespesasController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
