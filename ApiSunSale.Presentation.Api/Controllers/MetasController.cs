...
using IMainAppService = ApiSunSale.Application.Interfaces.IMetasAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Metas")]
    public class MetasController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public MetasController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
