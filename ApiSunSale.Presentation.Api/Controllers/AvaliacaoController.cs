...
using IMainAppService = ApiSunSale.Application.Interfaces.IAvaliacaoAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Avaliacao")]
    public class AvaliacaoController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public AvaliacaoController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
