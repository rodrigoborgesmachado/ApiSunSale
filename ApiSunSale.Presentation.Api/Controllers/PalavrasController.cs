...
using IMainAppService = ApiSunSale.Application.Interfaces.IPalavrasAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Palavras")]
    public class PalavrasController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public PalavrasController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
