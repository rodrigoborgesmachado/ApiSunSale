...
using IMainAppService = ApiSunSale.Application.Interfaces.IResultadossoletrandoAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Resultadossoletrando")]
    public class ResultadossoletrandoController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ResultadossoletrandoController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
