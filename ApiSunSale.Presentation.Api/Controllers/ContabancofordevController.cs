...
using IMainAppService = ApiSunSale.Application.Interfaces.IContabancofordevAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Contabancofordev")]
    public class ContabancofordevController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ContabancofordevController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
