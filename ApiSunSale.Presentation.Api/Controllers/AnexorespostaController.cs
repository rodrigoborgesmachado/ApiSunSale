...
using IMainAppService = ApiSunSale.Application.Interfaces.IAnexorespostaAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Anexoresposta")]
    public class AnexorespostaController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public AnexorespostaController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
