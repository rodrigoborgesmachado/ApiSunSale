...
using IMainAppService = ApiSunSale.Application.Interfaces.ILicencassunsaleproAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("LicencasSunSalePro")]
    public class LicencassunsaleproController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public LicencassunsaleproController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
