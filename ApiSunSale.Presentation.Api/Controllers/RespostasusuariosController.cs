...
using IMainAppService = ApiSunSale.Application.Interfaces.IRespostasusuariosAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Respostasusuarios")]
    public class RespostasusuariosController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public RespostasusuariosController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
