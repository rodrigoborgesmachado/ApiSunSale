...
using IMainAppService = ApiSunSale.Application.Interfaces.ICategoriaalimentosAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Categoriaalimentos")]
    public class CategoriaalimentosController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public CategoriaalimentosController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
