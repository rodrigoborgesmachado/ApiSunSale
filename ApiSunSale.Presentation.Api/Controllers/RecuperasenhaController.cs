...
using IMainAppService = ApiSunSale.Application.Interfaces.IRecuperasenhaAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Recuperasenha")]
    public class RecuperasenhaController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public RecuperasenhaController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
