...
using IMainAppService = ApiSunSale.Application.Interfaces.ISimuladosAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Simulados")]
    public class SimuladosController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public SimuladosController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
