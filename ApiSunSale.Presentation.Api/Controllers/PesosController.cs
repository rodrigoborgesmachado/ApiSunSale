...
using IMainAppService = ApiSunSale.Application.Interfaces.IPesosAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Pesos")]
    public class PesosController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public PesosController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
