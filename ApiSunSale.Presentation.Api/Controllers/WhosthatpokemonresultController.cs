...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("WhosThatPokemonResult")]
    public class WhosthatpokemonresultController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public WhosthatpokemonresultController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
