...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("TipoPostagem")]
    public class TipopostagemController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public TipopostagemController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
