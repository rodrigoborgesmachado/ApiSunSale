...
using IMainAppService = ApiSunSale.Application.Interfaces.ITraducoesAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Traducoes")]
    public class TraducoesController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public TraducoesController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
