...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Biomas")]
    public class BiomasController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public BiomasController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
