...
using IMainAppService = ApiSunSale.Application.Interfaces.ICartaocreditodevtoolsAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Cartaocreditodevtools")]
    public class CartaocreditodevtoolsController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public CartaocreditodevtoolsController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
