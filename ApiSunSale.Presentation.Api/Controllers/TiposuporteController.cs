...
using IMainAppService = ApiSunSale.Application.Interfaces.ITiposuporteAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Tiposuporte")]
    public class TiposuporteController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public TiposuporteController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
