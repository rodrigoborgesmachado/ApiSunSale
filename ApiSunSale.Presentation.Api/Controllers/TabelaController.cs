...
using IMainAppService = ApiSunSale.Application.Interfaces.ITabelaAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Tabela")]
    public class TabelaController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public TabelaController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
