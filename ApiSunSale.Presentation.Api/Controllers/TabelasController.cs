...
using IMainAppService = ApiSunSale.Application.Interfaces.ITabelasAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Tabelas")]
    public class TabelasController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public TabelasController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
