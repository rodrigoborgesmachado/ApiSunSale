...
using IMainAppService = ApiSunSale.Application.Interfaces.INotascortesisuAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Notascortesisu")]
    public class NotascortesisuController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public NotascortesisuController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
