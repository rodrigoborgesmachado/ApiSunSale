...
using IMainAppService = ApiSunSale.Application.Interfaces.IAlimentosAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Alimentos")]
    public class AlimentosController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public AlimentosController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
