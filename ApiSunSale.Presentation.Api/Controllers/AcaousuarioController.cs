...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Acaousuario")]
    public class AcaousuarioController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public AcaousuarioController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
