...
using IMainAppService = ApiSunSale.Application.Interfaces.IComentariosquestoesAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("ComentariosQuestoes")]
    public class ComentariosquestoesController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ComentariosquestoesController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
