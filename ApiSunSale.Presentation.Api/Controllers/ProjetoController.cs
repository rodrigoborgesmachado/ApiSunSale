...
using IMainAppService = ApiSunSale.Application.Interfaces.IProjetoAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Projeto")]
    public class ProjetoController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ProjetoController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
