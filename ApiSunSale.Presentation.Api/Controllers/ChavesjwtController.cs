...
using IMainAppService = ApiSunSale.Application.Interfaces.IChavesjwtAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Chavesjwt")]
    public class ChavesjwtController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ChavesjwtController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
