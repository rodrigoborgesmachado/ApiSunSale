...
using IMainAppService = ApiSunSale.Application.Interfaces.IOleosessenciaisAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [ApiController]
    [Authorize]
    [Route("Oleosessenciais")]
    public class OleosessenciaisController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public OleosessenciaisController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
