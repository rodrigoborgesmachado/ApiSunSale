...
using IMainAppService = ApiSunSale.Application.Interfaces.ICamposAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Campos")]
    public class CamposController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public CamposController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
