...
using IMainAppService = ApiSunSale.Application.Interfaces.IModulosAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Modulos")]
    public class ModulosController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public ModulosController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
