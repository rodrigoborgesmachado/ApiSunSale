...
using IMainAppService = ApiSunSale.Application.Interfaces.IEmailanexosAppService;
...
namespace ApiSunSale.Presentation.Api.Controllers
{
    ...
    [Authorize]
    [Route("Emailanexos")]
    public class EmailanexosController : ControllerBase, IDisposable
    {
        ...
        /// Class constructor
        /// </summary>
        public EmailanexosController(IMainAppService mainAppService, IOptions<Settings> options, IHttpContextAccessor httpContextAccessor)
        {
