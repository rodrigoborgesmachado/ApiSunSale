...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IVerificacaousuarioRepository;
using IMainService = ApiSunSale.Application.Interfaces.IVerificacaousuarioAppService;
...
{
    public class VerificacaousuarioAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public VerificacaousuarioAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
