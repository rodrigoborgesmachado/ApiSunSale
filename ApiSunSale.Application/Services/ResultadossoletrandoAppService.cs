...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IResultadossoletrandoRepository;
using IMainService = ApiSunSale.Application.Interfaces.IResultadossoletrandoAppService;
...
{
    public class ResultadossoletrandoAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ResultadossoletrandoAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
