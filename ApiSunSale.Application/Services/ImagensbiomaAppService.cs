...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IImagensbiomaRepository;
using IMainService = ApiSunSale.Application.Interfaces.IImagensbiomaAppService;
...
{
    public class ImagensbiomaAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ImagensbiomaAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
