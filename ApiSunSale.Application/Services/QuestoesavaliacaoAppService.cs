...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IQuestoesavaliacaoRepository;
using IMainService = ApiSunSale.Application.Interfaces.IQuestoesavaliacaoAppService;
...
{
    public class QuestoesavaliacaoAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public QuestoesavaliacaoAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
