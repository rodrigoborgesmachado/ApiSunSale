...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ISavedresultswppRepository;
using IMainService = ApiSunSale.Application.Interfaces.ISavedresultswppAppService;
...
{
    public class SavedresultswppAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public SavedresultswppAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
