...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IUsuarioscrudformsRepository;
using IMainService = ApiSunSale.Application.Interfaces.IUsuarioscrudformsAppService;
...
{
    public class UsuarioscrudformsAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public UsuarioscrudformsAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
