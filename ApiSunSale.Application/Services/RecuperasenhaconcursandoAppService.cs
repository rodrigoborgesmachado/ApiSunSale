...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IRecuperasenhaconcursandoRepository;
using IMainService = ApiSunSale.Application.Interfaces.IRecuperasenhaconcursandoAppService;
...
{
    public class RecuperasenhaconcursandoAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public RecuperasenhaconcursandoAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
