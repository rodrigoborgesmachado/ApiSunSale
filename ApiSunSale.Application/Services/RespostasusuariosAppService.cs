...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IRespostasusuariosRepository;
using IMainService = ApiSunSale.Application.Interfaces.IRespostasusuariosAppService;
...
{
    public class RespostasusuariosAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public RespostasusuariosAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
