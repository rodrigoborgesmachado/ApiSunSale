...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IPalavrasRepository;
using IMainService = ApiSunSale.Application.Interfaces.IPalavrasAppService;
...
{
    public class PalavrasAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public PalavrasAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
