...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ISimuladosRepository;
using IMainService = ApiSunSale.Application.Interfaces.ISimuladosAppService;
...
{
    public class SimuladosAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public SimuladosAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
