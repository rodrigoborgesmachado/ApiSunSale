...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IProvaRepository;
using IMainService = ApiSunSale.Application.Interfaces.IProvaAppService;
...
{
    public class ProvaAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ProvaAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
