...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IRespostasquestoesRepository;
using IMainService = ApiSunSale.Application.Interfaces.IRespostasquestoesAppService;
...
{
    public class RespostasquestoesAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public RespostasquestoesAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
