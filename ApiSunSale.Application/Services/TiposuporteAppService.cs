...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITiposuporteRepository;
using IMainService = ApiSunSale.Application.Interfaces.ITiposuporteAppService;
...
{
    public class TiposuporteAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public TiposuporteAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
