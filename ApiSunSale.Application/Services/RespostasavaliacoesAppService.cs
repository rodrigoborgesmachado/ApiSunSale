...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IRespostasavaliacoesRepository;
using IMainService = ApiSunSale.Application.Interfaces.IRespostasavaliacoesAppService;
...
{
    public class RespostasavaliacoesAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public RespostasavaliacoesAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
