...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IChavesjwtRepository;
using IMainService = ApiSunSale.Application.Interfaces.IChavesjwtAppService;
...
{
    public class ChavesjwtAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ChavesjwtAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
