...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IBiomasRepository;
using IMainService = ApiSunSale.Application.Interfaces.IBiomasAppService;
...
{
    public class BiomasAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public BiomasAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
