...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITraducoesRepository;
using IMainService = ApiSunSale.Application.Interfaces.ITraducoesAppService;
...
{
    public class TraducoesAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public TraducoesAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
