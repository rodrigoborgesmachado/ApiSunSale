...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IEmpresafordevRepository;
using IMainService = ApiSunSale.Application.Interfaces.IEmpresafordevAppService;
...
{
    public class EmpresafordevAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public EmpresafordevAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
