...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.INotascortesisuRepository;
using IMainService = ApiSunSale.Application.Interfaces.INotascortesisuAppService;
...
{
    public class NotascortesisuAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public NotascortesisuAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
