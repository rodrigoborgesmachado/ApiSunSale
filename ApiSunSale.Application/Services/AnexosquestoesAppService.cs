...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IAnexosquestoesRepository;
using IMainService = ApiSunSale.Application.Interfaces.IAnexosquestoesAppService;
...
{
    public class AnexosquestoesAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public AnexosquestoesAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
