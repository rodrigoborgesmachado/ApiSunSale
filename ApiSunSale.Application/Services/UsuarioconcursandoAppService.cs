...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IUsuarioconcursandoRepository;
using IMainService = ApiSunSale.Application.Interfaces.IUsuarioconcursandoAppService;
...
{
    public class UsuarioconcursandoAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public UsuarioconcursandoAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
