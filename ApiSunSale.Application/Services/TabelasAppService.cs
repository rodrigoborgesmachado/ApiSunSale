...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITabelasRepository;
using IMainService = ApiSunSale.Application.Interfaces.ITabelasAppService;
...
{
    public class TabelasAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public TabelasAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
