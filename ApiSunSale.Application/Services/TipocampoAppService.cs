...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITipocampoRepository;
using IMainService = ApiSunSale.Application.Interfaces.ITipocampoAppService;
...
{
    public class TipocampoAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public TipocampoAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
