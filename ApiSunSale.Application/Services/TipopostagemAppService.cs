...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITipopostagemRepository;
using IMainService = ApiSunSale.Application.Interfaces.ITipopostagemAppService;
...
{
    public class TipopostagemAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public TipopostagemAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
