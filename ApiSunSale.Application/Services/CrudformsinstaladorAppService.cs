...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ICrudformsinstaladorRepository;
using IMainService = ApiSunSale.Application.Interfaces.ICrudformsinstaladorAppService;
...
{
    public class CrudformsinstaladorAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public CrudformsinstaladorAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
