...
using IMainService = ApiSunSale.Application.Interfaces.IMetasAppService;
...
{
    public class MetasAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public MetasAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
