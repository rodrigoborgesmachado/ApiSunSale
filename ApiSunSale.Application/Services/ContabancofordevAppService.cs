...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IContabancofordevRepository;
using IMainService = ApiSunSale.Application.Interfaces.IContabancofordevAppService;
...
{
    public class ContabancofordevAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ContabancofordevAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
