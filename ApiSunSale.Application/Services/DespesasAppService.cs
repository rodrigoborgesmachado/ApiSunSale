...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IDespesasRepository;
using IMainService = ApiSunSale.Application.Interfaces.IDespesasAppService;
...
{
    public class DespesasAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public DespesasAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
