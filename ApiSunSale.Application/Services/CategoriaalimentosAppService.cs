...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ICategoriaalimentosRepository;
using IMainService = ApiSunSale.Application.Interfaces.ICategoriaalimentosAppService;
...
{
    public class CategoriaalimentosAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public CategoriaalimentosAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
