...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ICodigostableRepository;
using IMainService = ApiSunSale.Application.Interfaces.ICodigostableAppService;
...
{
    public class CodigostableAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public CodigostableAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
