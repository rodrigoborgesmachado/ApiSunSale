...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IReceitasRepository;
using IMainService = ApiSunSale.Application.Interfaces.IReceitasAppService;
...
{
    public class ReceitasAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ReceitasAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
