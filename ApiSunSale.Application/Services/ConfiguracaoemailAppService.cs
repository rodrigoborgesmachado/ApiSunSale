...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IConfiguracaoemailRepository;
using IMainService = ApiSunSale.Application.Interfaces.IConfiguracaoemailAppService;
...
{
    public class ConfiguracaoemailAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ConfiguracaoemailAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
