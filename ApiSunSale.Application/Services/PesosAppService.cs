...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IPesosRepository;
using IMainService = ApiSunSale.Application.Interfaces.IPesosAppService;
...
{
    public class PesosAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public PesosAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
