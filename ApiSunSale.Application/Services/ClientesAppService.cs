...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IClientesRepository;
using IMainService = ApiSunSale.Application.Interfaces.IClientesAppService;
...
{
    public class ClientesAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ClientesAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
