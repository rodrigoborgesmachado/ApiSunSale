...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IConsultasRepository;
using IMainService = ApiSunSale.Application.Interfaces.IConsultasAppService;
...
{
    public class ConsultasAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ConsultasAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
