...
{
    public class CartaocreditodevtoolsAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public CartaocreditodevtoolsAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
