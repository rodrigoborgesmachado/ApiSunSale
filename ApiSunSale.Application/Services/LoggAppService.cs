...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ILoggRepository;
using IMainService = ApiSunSale.Application.Interfaces.ILoggAppService;
...
{
    public class LoggAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public LoggAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
