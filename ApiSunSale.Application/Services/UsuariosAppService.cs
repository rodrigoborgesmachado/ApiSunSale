...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IUsuariosRepository;
using IMainService = ApiSunSale.Application.Interfaces.IUsuariosAppService;
...
{
    public class UsuariosAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public UsuariosAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
