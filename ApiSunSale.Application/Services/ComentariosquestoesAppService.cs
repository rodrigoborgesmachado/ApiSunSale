...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IComentariosquestoesRepository;
using IMainService = ApiSunSale.Application.Interfaces.IComentariosquestoesAppService;
...
{
    public class ComentariosquestoesAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ComentariosquestoesAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
