...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITemp1Repository;
using IMainService = ApiSunSale.Application.Interfaces.ITemp1AppService;
...
{
    public class Temp1AppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public Temp1AppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
