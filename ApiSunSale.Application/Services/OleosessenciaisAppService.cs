...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IOleosessenciaisRepository;
using IMainService = ApiSunSale.Application.Interfaces.IOleosessenciaisAppService;
...
{
    public class OleosessenciaisAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public OleosessenciaisAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
