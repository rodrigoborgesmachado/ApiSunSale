...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITesteRepository;
using IMainService = ApiSunSale.Application.Interfaces.ITesteAppService;
...
{
    public class TesteAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public TesteAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
