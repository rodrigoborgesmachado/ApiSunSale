...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IResultadostabuadadivertidaRepository;
using IMainService = ApiSunSale.Application.Interfaces.IResultadostabuadadivertidaAppService;
...
{
    public class ResultadostabuadadivertidaAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ResultadostabuadadivertidaAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
