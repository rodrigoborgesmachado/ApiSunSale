...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ILicencassunsaleproRepository;
using IMainService = ApiSunSale.Application.Interfaces.ILicencassunsaleproAppService;
...
{
    public class LicencassunsaleproAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public LicencassunsaleproAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
