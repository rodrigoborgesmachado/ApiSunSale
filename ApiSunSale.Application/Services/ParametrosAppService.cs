...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IParametrosRepository;
using IMainService = ApiSunSale.Application.Interfaces.IParametrosAppService;
...
{
    public class ParametrosAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ParametrosAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
