...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IVersaoRepository;
using IMainService = ApiSunSale.Application.Interfaces.IVersaoAppService;
...
{
    public class VersaoAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public VersaoAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
