...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IProjetoRepository;
using IMainService = ApiSunSale.Application.Interfaces.IProjetoAppService;
...
{
    public class ProjetoAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ProjetoAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
