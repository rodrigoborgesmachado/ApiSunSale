...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IPostagemRepository;
using IMainService = ApiSunSale.Application.Interfaces.IPostagemAppService;
...
{
    public class PostagemAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public PostagemAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
