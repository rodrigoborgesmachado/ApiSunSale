...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IEmailbackupRepository;
using IMainService = ApiSunSale.Application.Interfaces.IEmailbackupAppService;
...
{
    public class EmailbackupAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public EmailbackupAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
