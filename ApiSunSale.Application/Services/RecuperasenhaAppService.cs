...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IRecuperasenhaRepository;
using IMainService = ApiSunSale.Application.Interfaces.IRecuperasenhaAppService;
...
{
    public class RecuperasenhaAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public RecuperasenhaAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
