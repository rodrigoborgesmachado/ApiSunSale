...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IAlimentosRepository;
using IMainService = ApiSunSale.Application.Interfaces.IAlimentosAppService;
...
{
    public class AlimentosAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public AlimentosAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
