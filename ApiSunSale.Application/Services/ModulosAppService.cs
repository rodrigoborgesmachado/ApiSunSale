...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IModulosRepository;
using IMainService = ApiSunSale.Application.Interfaces.IModulosAppService;
...
{
    public class ModulosAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ModulosAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
