...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IPessoasfordevRepository;
using IMainService = ApiSunSale.Application.Interfaces.IPessoasfordevAppService;
...
{
    public class PessoasfordevAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public PessoasfordevAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
