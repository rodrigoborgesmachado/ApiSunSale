...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITipoprovaRepository;
using IMainService = ApiSunSale.Application.Interfaces.ITipoprovaAppService;
...
{
    public class TipoprovaAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public TipoprovaAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
