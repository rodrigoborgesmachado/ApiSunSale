...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IAvaliacaoRepository;
using IMainService = ApiSunSale.Application.Interfaces.IAvaliacaoAppService;
...
{
    public class AvaliacaoAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public AvaliacaoAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
