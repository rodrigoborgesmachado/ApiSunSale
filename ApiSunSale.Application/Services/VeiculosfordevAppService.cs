...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IVeiculosfordevRepository;
using IMainService = ApiSunSale.Application.Interfaces.IVeiculosfordevAppService;
...
{
    public class VeiculosfordevAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public VeiculosfordevAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
