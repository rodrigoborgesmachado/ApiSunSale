...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IImagensplantaRepository;
using IMainService = ApiSunSale.Application.Interfaces.IImagensplantaAppService;
...
{
    public class ImagensplantaAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public ImagensplantaAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
