...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITabelasmodulosRepository;
using IMainService = ApiSunSale.Application.Interfaces.ITabelasmodulosAppService;
...
{
    public class TabelasmodulosAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public TabelasmodulosAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
