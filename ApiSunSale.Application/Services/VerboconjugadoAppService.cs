...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IVerboconjugadoRepository;
using IMainService = ApiSunSale.Application.Interfaces.IVerboconjugadoAppService;
...
{
    public class VerboconjugadoAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public VerboconjugadoAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
