...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ICamposRepository;
using IMainService = ApiSunSale.Application.Interfaces.ICamposAppService;
...
{
    public class CamposAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public CamposAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
