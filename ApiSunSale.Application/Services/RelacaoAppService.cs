...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IRelacaoRepository;
using IMainService = ApiSunSale.Application.Interfaces.IRelacaoAppService;
...
{
    public class RelacaoAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public RelacaoAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
