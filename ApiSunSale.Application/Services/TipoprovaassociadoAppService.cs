...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITipoprovaassociadoRepository;
using IMainService = ApiSunSale.Application.Interfaces.ITipoprovaassociadoAppService;
...
{
    public class TipoprovaassociadoAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public TipoprovaassociadoAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
