...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITipoperfilRepository;
using IMainService = ApiSunSale.Application.Interfaces.ITipoperfilAppService;
...
{
    public class TipoperfilAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public TipoperfilAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
