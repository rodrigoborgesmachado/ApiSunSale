...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IVerbosRepository;
using IMainService = ApiSunSale.Application.Interfaces.IVerbosAppService;
...
{
    public class VerbosAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public VerbosAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
