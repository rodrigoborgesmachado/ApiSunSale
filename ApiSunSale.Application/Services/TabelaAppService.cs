...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.ITabelaRepository;
using IMainService = ApiSunSale.Application.Interfaces.ITabelaAppService;
...
{
    public class TabelaAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public TabelaAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
