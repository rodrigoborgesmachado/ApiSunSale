...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IWhosthatpokemonresultRepository;
using IMainService = ApiSunSale.Application.Interfaces.IWhosthatpokemonresultAppService;
...
{
    public class WhosthatpokemonresultAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public WhosthatpokemonresultAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
