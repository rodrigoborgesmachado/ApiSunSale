...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IAcaousuarioRepository;
using IMainService = ApiSunSale.Application.Interfaces.IAcaousuarioAppService;
...
{
    public class AcaousuarioAppService : ServiceBase<MainDTO>, IMainService
    {
