...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IEmailanexosRepository;
using IMainService = ApiSunSale.Application.Interfaces.IEmailanexosAppService;
...
{
    public class EmailanexosAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public EmailanexosAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
