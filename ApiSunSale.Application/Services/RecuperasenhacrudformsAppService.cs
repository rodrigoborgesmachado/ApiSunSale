...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IRecuperasenhacrudformsRepository;
using IMainService = ApiSunSale.Application.Interfaces.IRecuperasenhacrudformsAppService;
...
{
    public class RecuperasenhacrudformsAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public RecuperasenhacrudformsAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
