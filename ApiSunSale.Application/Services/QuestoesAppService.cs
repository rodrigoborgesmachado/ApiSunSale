...
using IMainRepository = ApiSunSale.Domain.Interfaces.Repository.IQuestoesRepository;
using IMainService = ApiSunSale.Application.Interfaces.IQuestoesAppService;
...
{
    public class QuestoesAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public QuestoesAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
