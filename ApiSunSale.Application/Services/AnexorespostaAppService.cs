...
{
    public class AnexorespostaAppService : ServiceBase<MainDTO>, IMainService
    {
        ...
        public AnexorespostaAppService(IBlobStorageService blobStorageService, IOptions<Settings> options, IMainRepository mainRepository, ILoggerService loggerService)
